...
| **Bug** | **Fix** |
| ------- | ------- |
| JavaScript is returning long date and time by default (e.g. Saturday, 29-Oct-2022 00:11:14 UTC) | Added toLocaleDateString('en-CA') to convert the date to required format |
